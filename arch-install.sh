...
pacstrap /mnt linux linux-firmware networkmanager network-manager-applet intel-ucode nano vi zsh git efibootmgr --noconfirm --needed
...
pacman -S  mesa lib32-vulkan-intel vulkan-intel lib32-mesa --noconfirm --needed
